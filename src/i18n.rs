...
pub struct Strings {
    ...
    pub settings_typing_window_hint: &'static str,
    pub settings_click_grace_hint: &'static str,
    pub settings_max_restores_hint: &'static str,
    pub settings_restore_window_hint: &'static str,
    ...
    pub settings_forever: &'static str,
    pub minutes_suffix: &'static str,
...
pub static EN: Strings = Strings {
    ...
    settings_typing_window: "Typing window",
    settings_click_grace: "Your own click within",
    settings_max_restores: "Give up after",
    settings_restore_window: "Tries counted within",
    settings_typing_window_hint: "A key pressed this recently means you were typing, and a window arriving now is an interruption.",
    settings_click_grace_hint: "A click this recent means you opened the window yourself, so it is left alone.",
    settings_max_restores_hint: "Two programs fighting over the foreground is worse than one badly behaved program.",
    settings_restore_window_hint: "How long tries are remembered before the count starts again.",
    ...
    settings_forever: "never times out",
    minutes_suffix: "min",
...
pub static TR: Strings = Strings {
    ...
    settings_typing_window: "Yazıyor sayılma süresi",
    settings_click_grace: "Tıklama toleransı",
    settings_max_restores: "Şu denemeden sonra pes et",
    settings_restore_window: "Denemelerin sayıldığı süre",
    settings_typing_window_hint: "Bu kadar yakın basılan bir tuş yazıyordun demek; o an gelen pencere kesinti sayılır.",
    settings_click_grace_hint: "Bu kadar yakın bir tıklama pencereyi senin açtığın anlamına gelir, dokunulmaz.",
    settings_max_restores_hint: "İki programın ön plan için kavga etmesi, tek bir terbiyesiz programdan kötüdür.",
    settings_restore_window_hint: "Denemeler bu süre boyunca hatırlanır, sonra sayım baştan başlar.",
...
mod tests {
    ...
    fn pairs() -> Vec<(&'static str, &'static str, &'static str)> {
        ...
        fields![
            ...
            settings_typing_window_hint,
            settings_click_grace_hint,
            settings_max_restores_hint,
            settings_restore_window_hint,
            settings_behaviour,
            settings_flash,
            settings_autostart,
